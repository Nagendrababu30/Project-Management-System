...
public class ProductManagementApplication {
	...
	public static void main(String[] args) {
		...
		do {
			...
			System.out
					.println("1.Save Product 2.List all products 3.Get Product 4.Delete Product 5.Update Expiry Date");
			...
			case 1 -> {
				...
				saveProduct(new Product(productCode, productName, productDescrpition, LocalDate.of(2026, 07, 27),
			...
			default -> System.out.println("Inavild Choice");
			}
	...
	public static void getProductsOrderByCodeAsc() {
		
	}

	public static void getProductsOrderByNameDesc() {
		
	}

	public static void getProductsOrderByExpiryDateDesc() {
